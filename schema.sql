...
-- Kontakt Bar (tək nəfərlik stullar, kiçik daxili dairə, sağda giriş üçün boşluq — Bar13 ilə Bar1 arasında)
('Bar 1', 1, NULL, 65, 45, 'dot', 0),
('Bar 2', 1, NULL, 62, 40, 'dot', 0),
('Bar 3', 1, NULL, 56, 37, 'dot', 0),
('Bar 4', 1, NULL, 50, 36, 'dot', 0),
('Bar 5', 1, NULL, 44, 39, 'dot', 0),
('Bar 6', 1, NULL, 40, 44, 'dot', 0),
('Bar 7', 1, NULL, 38, 50, 'dot', 0),
('Bar 8', 1, NULL, 40, 56, 'dot', 0),
('Bar 9', 1, NULL, 44, 61, 'dot', 0),
('Bar 10', 1, NULL, 50, 64, 'dot', 0),
('Bar 11', 1, NULL, 56, 63, 'dot', 0),
('Bar 12', 1, NULL, 62, 60, 'dot', 0),
('Bar 13', 1, NULL, 65, 55, 'dot', 0);
